...
pheno <- read.csv("phenotypes_participants_850K.csv")
...
pDat$Sample_Name<-rownames(pDat)


##
qcReport(RGset, sampNames=pDat$Sample_Name, sampGroups=pDat$tissueType, pdf="qcReport_CB_Placenta.pdf") #
